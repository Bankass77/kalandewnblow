package DensagouService.gateway.auth;
...
import DensagouService.gateway.jwt.JwtUtil;
import DensagouService.gateway.router.RouterValidator;
...
public class AuthenticationFilter implements GatewayFilter {
	...
	private void populateRequestWithHeaders(ServerWebExchange exchange, String token) {
		...
		exchange.getRequest().mutate().header("id", String.valueOf(claims.get("id")))
				.header("role", String.valueOf("role")).build();
	}
