...
public class RabbitMqConfiguration {
	...
	@Bean
	public TopicExchange multiplicationExchange(@Value("${userService.exchange}") final String exchangeName) {
		...
		public boolean isFatal(Throwable t) {
			...
			if (t instanceof ListenerExecutionFailedException) {
				...
				log.error("Failed to process inbound message from queue "
						+ e.getFailedMessage().getMessageProperties().getConsumerQueue() + "; failed message: "
						+ e.getFailedMessage(), t);
			}
